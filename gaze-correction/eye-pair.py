...
def overlay(image, filter_img, face_landmarks, face_part, INDEXES, display=True):
    ...
    try:
        ...
        print(filter_img_height)
        print("********")
        print(filter_img_width)
        ...
        # Otherwise if the face part is an eye.
            ...
            location = (int(center[0]-2.5*filter_img_width/3), int(center[1]-filter_img_height/3))
...
camera_video = cv2.VideoCapture('/home/digital/selvapriyanka/AI-ML/gaze-correction/jeevika.mp4')
...
result = cv2.VideoWriter('res_jeevika.mp4', 
...
smoke_animation = cv2.VideoCapture('/home/digital/Downloads/teaching-video-neuroimages-functional-saccadic-oculomotor-disturbances-ovwqeypw_oAGbIyec.mp4')
